...
<title>My Replied Questions</title>
...
<select name="dateTimeOrder">
 ...
 first
<button class="btn btn-success" formaction="<spring:url value='/teacher/my_replied_questions' />">Go</button>
</form>
	<table class="table table-sm">
		<tr>
			<th></th>
			<th>My Replied Questions</th>
		</tr>
		<c:forEach var="q" items="${requestScope.myRepliedQuestions}">
			<tr>
