...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
      ...
      <a href="<spring:url value='/student/home' />"><i class="fa fa-home" aria-hidden="true"></i></i>HOME</a> 
    

    <a href="<spring:url value='/student/update?toUpdate=profile' />"><i class="fas fa-user-edit"></i>UPDATE PROFILE</a> &nbsp;
    <a href="<spring:url value='/student/update?toUpdate=password' />"><i class="fas fa-pen-alt"></i>UPDATE PASSWORD</a>
    </div> 
...
<a class="btn btn-secondary" href="<spring:url value='/student/post_question' />">Post A Question</a>
<a class="btn btn-secondary" href="<spring:url value='/student/my_questions?filterSubject=none&dateTimeOrder=desc' />">Show my asked questions</a>
<br>
<br>
<form>
...
<select name="dateTimeOrder">
 ...
 first
<button class="btn btn-success" formaction="<spring:url value='/student/home' />">Go</button>
</form>
<br>
<table class="table table-sm">
	...
	<c:forEach var="q" items="${sessionScope.studentFeed}">
		<tr>
			<td>${q.heading}</td>
