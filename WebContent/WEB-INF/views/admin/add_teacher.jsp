  ...
  <div class="container">
	...
	<table class="table table-sm">
		...
		<div class="form-group">
			<tr>
				<td><label for="name">Enter Teacher Name</label></td>
				<td><form:input path="name" id="name" class="form-control" required="required" /></td>
			</tr>
		</div>
		<div class="form-group">
			<tr>
				<td><label for="email">Enter Teacher Email</label></td>
				<td><form:input type="email" path="email" id="email" class="form-control" required="required" /></td>
			</tr>
		</div>
		<div class="form-group">
			<tr>
		...
		<div class="form-group">
			<tr>
				<td><label for="subject">Enter Teacher Subject</label></td>
				<td><form:select path="subject" id="subject" class="form-control" >
					<option value="none" disabled="disabled" selected="selected" hidden='<c:if test="${true}"></c:if>'>None selected</option>
					<form:options items="${sessionScope.subjectList}"/>
					</form:select>
				</td>
			</tr>
		</div>
			<tr>
				<td></td>
				<td><input class="btn btn-primary" type="submit" value="Add Teacher" /></td>
			</tr>
		</table> 
	</form:form>
